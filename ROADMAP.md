...
- [x] Proyecto 5 — Purple Team Simulation *(matriz cobertura ATT&CK: 8 técnicas, 83% de lo emulado detectado; ciclo de mejora DEMOSTRADO en vivo (certutil image→commandLine: missed→fix→re-detectado) + ciclo DISEÑADO (regla 100180/T1490 para el gap de impacto, autorada en repo, despliegue pendiente de autorización); defensa en profundidad; el AR abrió 7 casos solos — 2026-06-15)*
- [ ] Proyecto 6 — Threat Intelligence Report
