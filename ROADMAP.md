...
- [x] Proyecto 7 — SOC Metrics Dashboard *(capstone HTML self-contained que agrega P1-P6: 19 reglas, 14 técnicas/8 tácticas ATT&CK, 6 fuentes de datos, severidad, 7 casos AR, 85.7% cobertura Purple, 3 ciclos de mejora, MTTD/MTTR de ejercicios; + metodología con queries Wazuh reproducibles. **Portfolio 7/7 COMPLETO** — 2026-06-20)*
